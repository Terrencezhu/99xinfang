      ...
      <header>
		...
		<div id="right">
			<div class="right-list">
				<ul class="xiugai-nav">
					<li style="background: #c73619;color:#fff;">人员信息</li>
					<li>搜索</li>
				</ul>
				<div class="xiugai-list wenzhang" style="display: block;">
					<div class="xiugai-fenye">
						...
						<?php if(is_array($counselor_list)): $i = 0; $__LIST__ = $counselor_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul class="xiugai-body">
							<li><?php echo ($vo["counselor_name"]); ?></li>
							<li><?php echo ($vo["sex"]); ?></li>
							<li><?php echo ($vo["region"]); ?></li>	
							<li>
